...
function renderNavBar() {
    ...
    navBarContent += `
        <div class="flex flex-row space-x-5 px-5 ">
            ...
            <button type="button" onclick="signin()" class="p-2 px-4 border rounded-full text-green-400 border-green-400 hover:bg-green-400 hover:text-white hidden sm:block">Sign In</button>
