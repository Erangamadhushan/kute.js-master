...
let aboutUsContent = `
    <div class=" text-center p-10 py-5 my-5 border border-green-400 transition-500 duration-300 hover:scale-[1.03]">
    ...
    <div class=" text-center p-10 py-5 my-5 border border-green-400 transition-500 hover:scale-[1.03]">
...
aboutUsSubContainer.innerHTML = `
    <div class="W-[900PX] text-center p-10 my-5 grid grid-cols-1 gap-[30px]">
        <div class="border border-green-400 p-5 transition-500 hover:scale-[1.03]">
