        ...
        if(ele.category == data) {
            itemCategoryItemContent += `
                <div class="w-[350px] mx-auto p-4 border border-green-400 rounded-lg" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="200" data-aos-placement="bottom-center">
                    ...
                    <h2>${ele.category}</h2>
                    <button type="button" class=" mt-5 p-2 bg-transparent rounded-full border border-green-400 text-green-400 hover:bg-green-400 hover:text-white categoryBtn" onclick="purchaseItem()">Purchase Item</button>
                </div>
            `;
        }
    })
